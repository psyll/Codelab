...
class Cron
{
	...
	public static function log(string $message)
	{
		if (CL_PACKAGES['cron']['config']['logs']['enabled'] == true) :
			...
			$logsPath = $logsDirPath . DIRECTORY_SEPARATOR . CL_PACKAGES['cron']['config']['logs']['filenamePrefix']
						. date("Y-m-d") . CL_PACKAGES['cron']['config']['logs']['filenameSuffix'] . '.log';
	...
	public static function work()
	{
		...
		$json = json_encode($cronJOBS, JSON_PRETTY_PRINT|JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
